...
// instance, it correctly creates a sub task using on that type.
//
...
// not log at all.
func WithLogWriter(log func(name, message string)) Option {
...
// Run is roughly the same as tesitng.T.Run.
